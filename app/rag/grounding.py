...
def build_strict_grounding_prompt(
    ...
    if broad_query:
        return (
            ...
            "8. EXHAUSTIVE EXTRACTION & NO TRUNCATION: Do NOT summarize, cut, or truncate the information. Return all related details, headings, and exact context exactly as it appears in the documents.\n"
