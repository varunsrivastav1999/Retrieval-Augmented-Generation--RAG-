...
def build_strict_grounding_prompt(
    ...
    return (
        ...
        "═══════════════════════════════════════════════════════════\n\n"
        "CRITICAL RULES:\n"
        "1. Extract the facts directly from the DATABASE RECORDS below.\n"
        "2. Do NOT use your general knowledge.\n"
        "3. Do NOT make up, infer, or guess any information.\n"
        "4. ABSOLUTELY PROHIBITED: Do not write conversational text. Do not mention manuals, contexts, pages, or records. Just provide the raw answer.\n"
        "5. Your ONLY job is to verbatim copy-paste the exact sentences and bullet points from the DATABASE RECORDS that answer the query. DO NOT summarize, paraphrase, truncate, or skip any details.\n"
        "6. If the document has a bulleted list of parameters, features, or options, you MUST copy the entire list word-for-word exactly as written in the record.\n"
        "7. Do NOT append 'Additional Information' or extra sections that the user didn't ask for.\n"
        "8. Do NOT include citations like 'From [Document]' in your text.\n"
        "9. Render tables as Markdown Pipe Tables.\n\n"
        "USER QUERY HANDLING:\n"
        "- Focus on the INTENT of the user's query.\n"
        f"{broad_instruction}"
        f"{topic_line}\n"
        f"DATABASE RECORDS:\n{context_text}\n\n"
