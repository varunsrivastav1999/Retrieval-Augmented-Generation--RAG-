...
def build_strict_grounding_prompt(
    ...
    return (
        ...
        "4. Do NOT add disclaimers like 'based on the provided context' — just answer directly.\n"
        "5. Include exact citations [source, Page N] for every claim.\n"
        "6. Render tables as Markdown Pipe Tables.\n"
        "7. Use bold text for key terms and bullet points for lists.\n"
        "8. Keep answers precise — include only what the documents say.\n"
        "9. Provide ONLY the answer. Do NOT include conversational filler, greetings, or extra words.\n"
        "10. Be extremely concise. If the answer is a single word or short phrase, output ONLY that word or phrase.\n\n"
        "USER QUERY HANDLING:\n"
