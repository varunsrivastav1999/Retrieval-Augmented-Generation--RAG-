...
def build_strict_grounding_prompt(
    ...
    if broad_query:
        return (
            ...
            "3. Every claim MUST cite its source document in brackets: [filename.pdf].\n"
            "4. Group related information from the same document together.\n"
            "5. If the records contain tables or lists, reproduce them faithfully.\n"
            "6. If NO record contains relevant information, say: "
            "'This information is not available in the uploaded documents.'\n"
            f"{topic_line}\n"
            "-----------------------------------------------------------\n"
            f"DATABASE RECORDS:\n{context_text}\n"
    ...
    return (
        "═══════════════════════════════════════════════════════════\n"
        "  SYSTEM: Technical Document Extractor\n"
        "  MODE: EXACT TEXT EXTRACTION — CITED\n"
        "═══════════════════════════════════════════════════════════\n\n"
        "RULES:\n"
        "1. You have NO general knowledge. ONLY use the DATABASE RECORDS below.\n"
        "2. Find the exact paragraphs that answer the user's question.\n"
        "3. COPY AND PASTE them verbatim — 100% character-for-character.\n"
        "4. At the end of your answer, cite the source: [filename.pdf, Page X].\n"
        "5. Render tables exactly as they appear.\n"
        "6. DO NOT summarize, paraphrase, or add explanations.\n"
        "7. If NO record contains the answer, say: "
        "'This information is not available in the uploaded documents.'\n"
        f"{topic_line}\n"
        "-----------------------------------------------------------\n"
        f"DATABASE RECORDS:\n{context_text}\n"
