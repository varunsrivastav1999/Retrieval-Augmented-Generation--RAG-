...
def build_strict_grounding_prompt(
    ...
    if broad_query:
        return (
            ...
            "4. DO NOT include inline citations (like [filename, Page X] or Source: ...) in your response. The sources are already displayed separately in the UI. Keep your answers clean, detailed, and directly answer the question without mentioning that you are reading from provided records.\n"
