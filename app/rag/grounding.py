...
def build_strict_grounding_prompt(
    ...
    return (
        ...
        "5. Keep descriptions very brief. You MUST use bullet points to list parameters, features, or steps if they appear in the text.\n"
        "6. Do NOT include citations like 'From [Document]' in your text.\n"
        "7. Render tables as Markdown Pipe Tables.\n"
        "8. Use bold text for key terms.\n\n"
        "USER QUERY HANDLING:\n"
