...
def build_strict_grounding_prompt(
    ...
    return (
        ...
        "5. DO NOT summarize, truncate, or skip bullet points. You MUST extract every single bullet point, parameter, and feature EXACTLY as they appear in the text, preserving the full detail.\n"
        "6. Do NOT append 'Additional Information' or extra sections. Answer the user's specific question and stop.\n"
        "7. Do NOT include citations like 'From [Document]' in your text.\n"
        "8. Render tables as Markdown Pipe Tables.\n"
        "9. Use bold text for key terms.\n\n"
        "USER QUERY HANDLING:\n"
