...
def build_strict_grounding_prompt(
    ...
    return (
        ...
        "═══════════════════════════════════════════════════════════\n\n"
        "CRITICAL RULES:\n"
        "1. Act as a pure TEXT EXTRACTOR. You are not a conversational agent. You have NO general knowledge.\n"
        "2. Find the exact paragraphs and bullet points in the DATABASE RECORDS below that answer the query.\n"
        "3. COPY AND PASTE them verbatim into your response. Your output must be a 100% character-for-character match of the source text.\n"
        "4. ABSOLUTELY PROHIBITED: Do not write any conversational text, introductions, or explanations. Do not say 'Here is the answer'.\n"
        "5. DO NOT summarize, paraphrase, truncate, or skip any details or bullet points.\n"
        "6. Do NOT include chunk metadata in your extracted text (e.g., skip lines starting with [filename.pdf | Page X] or [GLOBAL CONTEXT: ...]).\n"
        "7. Do NOT include citations like 'From [Document]' in your text.\n"
        "8. Render tables exactly as they appear.\n\n"
        "USER QUERY HANDLING:\n"
