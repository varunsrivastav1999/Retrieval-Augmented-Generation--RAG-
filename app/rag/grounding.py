...
def build_strict_grounding_prompt(
    ...
    return (
        ...
        "8. NO FILLER WORDS: DO NOT use introductory filler phrases like 'According to the provided text', 'Based on the document', or 'The text states'. Start your answer immediately with the requested facts.\n"
        f"{topic_line}\n"
        "-----------------------------------------------------------\n"
        f"DATABASE RECORDS:\n{context_text}\n"
        "-----------------------------------------------------------\n\n"
